...
var close_button = document.getElementById('js-menu-toggle'),
    ...
    array_of_select_id = ['js-city-select', 'js-specialist-select', 'js-area-select', 'js-select-result-order'],
    array_of_slider_id = ['js-doctor-services', 'js-specializes', 'js-offers'],
  ...
  breakpoints: {
    ...
    login_input = document.querySelector('.login-form #email-input'); // Toggle menu on navbar
...
array_of_select_id.forEach(function (selector_id) {
  'use strict';

  var temp = document.getElementById(selector_id);
